...
filtered_df = df[df['autoscaler'].isin(['KEDA', 'Knative', 'Reflex (Serverless)'])]

# Define the plot parameters
plot_params = [
    ('avg_memory_mib', 'idle', 'Average Memory Usage (Idle)', 'faas_avg_memory_idle.png'),
    ('avg_memory_mib', 'busy', 'Average Memory Usage (Busy)', 'faas_avg_memory_busy.png'),
    ('avg_cpu_millicores', 'idle', 'Average CPU Usage (Idle)', 'faas_avg_cpu_idle.png'),
    ('avg_cpu_millicores', 'busy', 'Average CPU Usage (Busy)', 'faas_avg_cpu_busy.png'),
]
