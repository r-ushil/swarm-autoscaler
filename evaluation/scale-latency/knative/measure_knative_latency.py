...
def start_wrk():
    wrk_command = ["wrk", "-t1", "-c15", "-d650s", "-H", "Host: apache.default.example.com", "http://192.168.1.3:30080"]
...
def measure_latency(iteration, ssh_host):
    ...
    try:
        ...
        monitor_command = "nohup /root/monitor_knative_scale.sh > /dev/null 2>&1 &"
